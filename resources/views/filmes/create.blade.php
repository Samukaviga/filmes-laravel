<x-layout :mensagem-sucesso="session('mensagemSucesso')">
    ...
    <div class="pl-0 h-full w-fill md:pl-64">
        ...
        <div class="flex flex-col items-center h-full w-fill p-5">
            ...
            <form action="{{ route('film.store') }}" method="POST" class="w-full border rounded-md p-5" enctype="multipart/form-data">
                @csrf
                <div class="mb-5">
