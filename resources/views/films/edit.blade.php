<x-layout>
    ...
    <div class="pl-0 h-full w-fill md:pl-64">
        ...
        <div class="flex flex-col items-center h-full w-fill p-5">
            ...
            <div class="w-full border border-gray-700 rounded-md p-5">
                <form action="{{ route('film.update', $film->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Sinopse do filme...">{{ $film->description }}</textarea>
                    ...
                    <div class="mb-5">
                        ...
                        <img src="{{ $film->image ? asset('storage/' . $film->image) : asset('imagens/sem-foto.webp')  }}"
                            alt="Capa do filme" class="w-28 h-auto object-contain rounded mb-2">
                    </div>
