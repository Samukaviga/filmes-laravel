    ...
    <div class=" pl-0 md:pl-64">
        ...
        <div class="p-5 flex justify-center md:justify-start gap-2 flex-wrap">
            ...
            @foreach ($films as $film)
                ...
                <div class="w-64 bg-gray-800 border border-gray-600 rounded-lg shadow-sm">
                    <a href="{{ route('film.description', $film->id) }}">
                        <img class="rounded-t-lg w-full h-80 object-cover object-center"
                            src="{{ $film->image ? asset('storage/' . $film->image) : asset('imagens/sem-foto.webp') }}"
                            alt="Capa do film {{ $film->name }}" />
                    </a>
                    <div class="p-5">
